---
name: api-design
description: Use when designing REST or GraphQL APIs, creating OpenAPI specifications, or planning API architecture. Covers resource modeling, versioning, pagination, error handling, and OpenAPI 3.1.
license: MIT
---
